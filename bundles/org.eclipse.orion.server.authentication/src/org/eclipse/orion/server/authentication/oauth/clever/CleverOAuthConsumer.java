...
/**
 * Clever specific OAuthConsumer used to handle Clevers oauth token responses.
 * @author Billy Figueroa
 *
 */
public class CleverOAuthConsumer extends OAuthConsumer{
	...
	private static final String PROFILE_URL        = "https://api.clever.com/user";
	private static final String EMAIL_URL          = "https://api.clever.com/user/emails";
	...
	public CleverOAuthConsumer(OAuthAccessTokenResponse oauthAccessTokenResponse, String redirect) throws OAuthException {
		super(oauthAccessTokenResponse, redirect);
		getCleverProfile();
		getCleverEmail();
	}

	private void getCleverProfile() throws OAuthException{
	...
	private void getCleverEmail() throws OAuthException{
	...
	public String getUsername() {
		// clever allows a dash in the username, so remove any dashes
